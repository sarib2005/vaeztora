  ...
  return (
    <section className="w-full bg-[#f9f9fb] py-14 sm:py-12 select-none">
      ...
      <div className="w-full px-4 sm:px-6 md:px-8 lg:px-[98px]">
        ...
        {/* Giant Main Container with entrance lift */}
        <motion.div
        ...
        >
          ...
          >
            ...
            >
              ...
              <div className="absolute top-0 inset-x-0 h-16 bg-gradient-to-b from-neutral-900 via-neutral-900/60 to-transparent z-20 pointer-events-none" />
              <div className="absolute bottom-0 inset-x-0 h-16 bg-gradient-to-t from-neutral-900 via-neutral-900/60 to-transparent z-20 pointer-events-none" />
                    ...
                    <div className="flex flex-wrap gap-2">
                      {modalProduct.sizes.map((size) => (
                        <button
                          ...
                          className={`w-9 h-9 rounded-xl font-sans text-xs font-semibold flex items-center justify-center transition-all cursor-pointer ${
                            selectedSize === size
                        ...
                        {modalProduct.colors.map((c) => (
                          <button
                            ...
                            className={`w-7 h-7 rounded-full border-2 transition-all cursor-pointer ${
                              selectedColor.name === c.name ? 'border-black scale-110' : 'border-transparent'
                            }`}
...
function ProductLoopCard({
  ...
  return (
    <div
      onClick={onQuickView}
      className="group relative aspect-[3/4] w-full rounded-2xl sm:rounded-3xl overflow-hidden bg-[#d9dde0] cursor-pointer shadow-lg shrink-0"
    >
      <img
        src={product.image}
        alt={product.title}
      ...
      <div className="absolute inset-0 bg-black/15 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center z-10 pointer-events-none">
        <span className="px-3.5 py-1.5 rounded-full bg-white/95 backdrop-blur-md text-neutral-950 font-sans text-[11px] font-semibold shadow-lg transform translate-y-2 group-hover:translate-y-0 transition-all duration-300 flex items-center gap-1.5">
      ...
      <div className="absolute bottom-3 left-3 right-3 z-10 pointer-events-none">
        <div className="bg-white rounded-xl py-2 px-3 shadow-md space-y-0.5">
